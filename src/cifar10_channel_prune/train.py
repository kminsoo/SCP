...
def get_ops(images, labels):
  ...
  if FLAGS.network == "ResNet":
    from src.cifar10_channel_prune.ResNet import resnet
    network = resnet(images, labels,
                        num_residual_block=27,
                        batch_size=FLAGS.batch_size)
  elif FLAGS.network == "VggNet19":
    from src.cifar10_channel_prune.Vgg import vggnet
    ...
    from src.cifar10_channel_prune.DenseNet import densenet
